class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("ground", "ground/ground.png");
  ...
  addUnlockedUI() {
    ...
    this.productImage = this.add.image(400, 595, "product1").setScale(0.35);
  ...
  startGame() {
    ...
    this.addScores();
    this.addLife();
    this.add.image(600, 900, "ground").setScale(3);
  ...
  addGround() {
    this.add.image(this.player.x + 2600 * 1.5 - 200, 900, "ground").setScale(3);
    this.time.addEvent({
      delay: (25500 * 1.5 * 100) / this.player.speed,
      callback: () => {
        this.addGround();
      },
    });
